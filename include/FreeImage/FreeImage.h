...
typedef BOOL (DLL_CALLCONV *FI_GetFileWHProc)(unsigned* width, unsigned* height, FreeImageIO *io, fi_handle handle, int page, int flags, void *data);
...
DLL_API BOOL DLL_CALLCONV FreeImage_GetFileWH(unsigned* width, unsigned* height, FREE_IMAGE_FORMAT fif, const char *filename, int size FI_DEFAULT(0));
DLL_API BOOL DLL_CALLCONV FreeImage_GetFileWHU(unsigned* width, unsigned* height, FREE_IMAGE_FORMAT fif, const wchar_t *filename, int size FI_DEFAULT(0));
DLL_API BOOL DLL_CALLCONV FreeImage_GetFileWHFromHandle(unsigned* width, unsigned* height, FREE_IMAGE_FORMAT fif, FreeImageIO *io, fi_handle handle, int flag FI_DEFAULT(0));
