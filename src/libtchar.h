#ifndef __LIBTCHAR_H_INCLUDE
#define __LIBTCHAR_H_INCLUDE

#undef __LIBTCHAR_H_USESYS
#if defined(_MSC_VER)    // MSVC.
    #define __LIBTCHAR_H_USESYS
    ...
    #define __LIBTCHAR_H_USESYS
#else
       // other playform not support tchar.h
#endif    // __LIBTCHAR_H_USESYS


#ifdef __LIBTCHAR_H_USESYS
    #include <tchar.h>
